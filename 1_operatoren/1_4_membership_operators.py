...
# in überprüft also, ob der Wert von x in der collection y enthalten ist. Ist das der Fall -> True.
# Ist das nicht der Fall -> False.

# not in ist das genaue Gegenteil von in. Ist der Wert von x in y enthalten -> False. Ist er nicht
# enthalten -> True.